...
- see 01,02-files/flex.css for detailed explanation for each of possible values
...
- Using viewport width and height in CSS: `100vh` and `100vw` - full viweport width and height
- CSS supports 4 Math functions as values: `calc`, `min`, `max`, `clamp`
  ...
  - e.g. setting main's `min-height: calc(100vh - 30px)`
    - we have a 30px header and the rest of the viweport should have content
