...
| [/sport/{sport}/scheduled-events/{date}](#Sport scheduled)                | `{ events: Event[] }`                    | https://academy.dev.sofascore.com/api/v1/sport/football/scheduled-events/2021-05-07 |
...
| [/unique-tournament/image](#Unique-Tournament)                            | `{ uniqueTournament: UniqueTournament }` | https://academy.dev.sofascore.com/api/v1/unique-tournament/17                       |
